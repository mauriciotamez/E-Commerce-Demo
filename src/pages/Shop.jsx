...
import { filterCategoryThunk, filterProductThunk, getCategoriesThunk, getShopListThunk, setShopList } from '../redux/actions';
            ...
            <div className='pt-10 -pl-12'>
                <div className='flex justify-center'>
                  <form onSubmit={filterProduct} className='pt-20 pl-12 '>
                    <input className=' appearance-none border-b-[1px] outline-none	 border-slate-500  bg-[#faf8f0]' 
